...
***If you're looking for the Docker Swarm version please go to [rlrajiv/swarmprom](https://github.com/rlrajiv/swarmprom)***
...
```bash
git clone https://github.com/rlrajiv/prometheus.git
cd prometheus
...
![Host](https://raw.githubusercontent.com/rlrajiv/prometheus/master/screens/Grafana_Docker_Host.png)
...
![Containers](https://raw.githubusercontent.com/rlrajiv/prometheus/master/screens/Grafana_Docker_Containers.png)
...
![Monitor Services](https://raw.githubusercontent.com/rlrajiv/prometheus/master/screens/Grafana_Prometheus.png)
...
Three alert groups have been setup within the [alert.rules](https://github.com/rlrajiv/prometheus/blob/master/prometheus/alert.rules) configuration file:

* Monitoring services alerts [targets](https://github.com/rlrajiv/prometheus/blob/master/prometheus/alert.rules#L2-L11)
* Docker Host alerts [host](https://github.com/rlrajiv/prometheus/blob/master/prometheus/alert.rules#L13-L40)
* Docker Containers alerts [containers](https://github.com/rlrajiv/prometheus/blob/master/prometheus/alert.rules#L42-L69)
...
The notification receivers can be configured in [alertmanager/config.yml](https://github.com/rlrajiv/prometheus/blob/master/alertmanager/config.yml) file.
...
![Slack Notifications](https://raw.githubusercontent.com/rlrajiv/prometheus/master/screens/Slack_Notifications.png)
